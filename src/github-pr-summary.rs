...
async fn handler(
    ...
    if new_commit {
        ...
        match issues.create_comment(pull_number, "Hello, I am a code review bot.It could take a few minutes for me to analyze this PR. Relax, grab a cup of coffee and check back later. Thanks!").await {
            Ok(comment) => {
